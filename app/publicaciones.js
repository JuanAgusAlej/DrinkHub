...
const guardarPublicacion = function () {
    ...
    let ingredientes = document.getElementById('modal_ingrediente').value.split('-')
    ...
    recetas.unshift(new Receta(titulo, ingredientes, preparacion, imagen, user.nick))
