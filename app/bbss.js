...
const agregarProducto = function () {
    productos.push(new Productos('Fernet', 5, 700.00, '../img/producto/fernet.png'))
    productos.push(new Productos('Andes', 25, 200.00, '../img/producto/andes.png'))
    productos.push(new Productos('Gin', 30, 2478.00, '../img/producto/gin.png'))
    productos.push(new Productos('Vodka', 10, 836.00, '../img/producto/vodka.png'))
    productos.push(new Productos('Ron blanco', 20, 1485.00, '../img/producto/ronBlanco.png'))
    productos.push(new Productos('Zumo de tomate', 20, 40.00, '../img/producto/zumoTomate.png'))
    productos.push(new Productos('Zumo de limón', 20, 40.00, '../img/producto/zumoLimon.png'))
    productos.push(new Productos('Salsa Tabasco', 40, 100.00, '../img/producto/salsaTabasco.png'))
    productos.push(new Productos('Salsa Worcestershire', 150, 120.00, '../img/producto/salsaWorcestershire.png'))
    productos.push(new Productos('Campari', 200, 724.00, '../img/producto/campari.png'))
    productos.push(new Productos('Vermú rojo', 100, 1400.00, '../img/producto/vermuRojo.png'))
    productos.push(new Productos('Ginebra', 3, 3000.00, '../img/producto/ginebra.png'))
    productos.push(new Productos('Soda', 400, 50.00, '../img/producto/soda.png'))
    productos.push(new Productos('Hielo', 5, 100.00, '../img/producto/hielo.png'))
    productos.push(new Productos('Leche de coco', 20, 350.00, '../img/producto/lecheCoco.png'))
    productos.push(new Productos('Zumo de piña', 30, 400.00, '../img/producto/zumonPiña.png'))
    productos.push(new Productos('Vino Manzanilla', 30, 2400.00, '../img/producto/vinoManzana.png'))
